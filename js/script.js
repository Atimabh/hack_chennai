...
for (var i = 0; i < len; i++) {
    ...
    var html = '<div class="col-md-3"><div class="mentorCard"><div class="mentorImage"><img src="images/mentors/' + img[i] + '"></div><div class="mentorText"><h1 class="text-center">' + mentor[i] + '</h1><a href="#"><div class="linkedin"><i class="fab fa-linkedin-in"></i></div></a></div><div class="mentorSkills">' + skills[i] + '</div></div></div>';
